...
public class FXMLSGPMainDashboardCntl extends NavigationCntl implements Initializable {
    @FXML Label actiontarget;
    @FXML Text welcome;
    public FXMLSGPMainDashboardCntl(){
    ...
    public void initialize(URL url, ResourceBundle rb) {
        welcome.setText("Welcome "+ this.getCurrentUser()+"!");
    }  
